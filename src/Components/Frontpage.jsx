            ...
            <main>
                <div className="ml-20 mr-20 justify-between flex gap-20">
                    ...
                    <div className="flex-col w-2/3 mt-8">
                        ...
                        <ScrollArea
                            className="h-[30vh] rounded-xl p-4 overflow-y-auto scrollbar-thin scrollbar-custom bg-[#48B936] bg-opacity-20">
                        ...
                        <div className="justify-between mt-8">
                            <DropdownMenu>
                                <DropdownMenuTrigger
                                    className="hover:bg-[#003811] h-[5vh] w-[30vh] px-4 py-2 bg-[#00693c] text-white rounded-md font-bold text-2xl">
                                    BRILLER
                                </DropdownMenuTrigger>
                                <DropdownMenuContent className="p-2 shadow-none border-none"
                                    ...
                                    <DropdownMenuItem asChild>
                                        <a href="https://media.relesysapp.net/secure/media-secure/910/4415a5e8-33a1-4465-a70d-c230ed9b4a10/Louis_Nielsen_Produktkatalog_-_efteraar_2024.pdf"
                                           ...
                                           className="hover:font-bold text-[#003811] hover:bg-transparent">Glas
                                            katalog</a>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <a href="https://media.relesysapp.net/secure/media-secure/910/cee356a1-2f67-42d5-bd94-1e65bb4da63e/Produktkatalog_-_overblik_over_glas.pdf"
                                           target="_blank"
                                           rel="noopener noreferrer"
                                           className="hover:font-bold text-[#003811] hover:bg-transparent">Lens Overview
                                            - Varifocals</a>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <a href="https://media.relesysapp.net/secure/media-secure/910/d21f2eb0-59a2-478d-b263-e8569b9073c7/Optileks_katalog_NESO_version_-_ny_sept_24.pdf"
                                           target="_blank"
                                           rel="noopener noreferrer"
                                           className="hover:font-bold text-[#003811] hover:bg-transparent">Optileks
                                            katalog</a>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger
                                    className="hover:bg-[#003811] h-[5vh] w-[30vh] px-4 py-2 bg-[#00693c] text-white rounded-md font-bold text-2xl mt-4">
                                    KONTAKTLINSER
                                </DropdownMenuTrigger>
                                <DropdownMenuContent className="p-2 shadow-none border-none"
                                                     style={{backgroundColor: "transparent"}}>
                                    ...
                                    <DropdownMenuItem asChild>
                                        <a href="https://media.relesysapp.net/secure/media-secure/910/d030adcf-bf07-4a43-9b60-e5e3425661b9/Prisliste_core.pdf"
                                           target="_blank"
                                           rel="noopener noreferrer"
                                           className="hover:font-bold text-[#003811] hover:bg-transparent">Core Range
                                            tabel</a>
                                    </DropdownMenuItem>
                                </DropdownMenuContent>
                            </DropdownMenu>
