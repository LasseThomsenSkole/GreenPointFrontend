                    ...
                    <ul className="flex space-x-4">
                        <li className="mt-6 mr-8"><DropdownMenu>
                            ...
                            <DropdownMenuContent>
                                ...
                                <DropdownMenuItem><a href="http://intranet/daglig.php"
                                                     target="_blank"
                                                     rel="noopener noreferrer">Daglig omsætning</a></DropdownMenuItem><DropdownMenuSeparator />
                        ...
                        <li><DropdownMenu>
                            ...
                            <DropdownMenuContent className="font-bold">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                       className="size-6">
